            ...
            <div class="h-full bg-gray-100 dark:bg-gray-800 p-8 rounded">
              ...
              <a class="inline-flex items-center">
                ...
                <span class="flex-grow flex flex-col pl-4">
                  <span class="title-font font-medium text-gray-900 dark:text-white">Ariful Islam</span>
                  <span class="text-gray-500 text-sm">Laravel & Vuejs Developer</span>
                </span>
              </a>
            </div>
          </div>
          <div class="p-4 md:w-1/2 w-full">
            <div class="h-full bg-gray-100 dark:bg-gray-800 p-8 rounded">
              ...
              <p class="leading-relaxed mb-6">
                যখনই কোন কিছুতে ঘাবড়াইয়া যাইতাম, আটকে যাইতাম তখনি জাকির ভাই আমাদের সাহস দিত, ভরসা দিয়ে দেখাইয়া দিত আএইভাবে এইভাবে করে ফেলবেন। দেখা গেছে, আমার সাহস এত বেড়ে গেছে এখন মনে হয় আমি পারবো। জাকির ভাই গাইডলাইন খুব ভাল দেয়।
              </p>
