        ...
        <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-6 basis-72 flex-shrink-0 bg-gray-900 dark:bg-gray-100 dark:text-gray-800 text-gray-100 mr-10">
            ...
            <div class="space-y-4 text-center divide-y divide-gray-300 dark:divide-gray-700">
              <div class="my-2 space-y-1">
                ...
                <p class="px-5 text-xs sm:text-base dark:text-gray-700">Full-stack developer</p>
              </div>
              <div class="flex justify-center pt-2 space-x-2 align-center">
                ...
                <a rel="noopener noreferrer" href="https://youtube.com/zakirhossen" aria-label="Youtube" class="p-2 rounded-md text-gray-800 dark:text-gray-100 hover:dark:text-violet-400">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="h-4 w-4 fill-gray-200 dark:fill-gray-700"><path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"/></svg>
                </a>
                ...
                <a rel="noopener noreferrer" href="https://facebook.com/web.zakirbd" aria-label="Email" class="p-2 rounded-md text-gray-800 dark:text-gray-100 hover:dark:text-violet-400">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-4 w-4 fill-gray-200 dark:fill-gray-700"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg>
                </a>
              </div>
            </div>
          </div>
