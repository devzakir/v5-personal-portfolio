          ...
          <div class="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-6 basis-72 flex-shrink-0 bg-gray-50 dark:bg-gray-900 dark:text-gray-100 mr-10">
            ...
            <div class="space-y-4 text-center divide-y divide-gray-700">
              ...
              <div class="flex justify-center pt-2 space-x-2 align-center">
                ...
                <a rel="noopener noreferrer" href="https://facebook.com/web.zakirbd" aria-label="Email" class="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
                  <img src="../assets/svg/envelop.svg" />
                </a>
              </div>
            </div>
          </div>
